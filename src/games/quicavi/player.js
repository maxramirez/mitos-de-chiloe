// EL BRUJO DE QUICAVÍ · player.js — first-person forest walker.
// Same controller family as the sibling games: WASD + Shift run, pointer-lock
// mouse look with arrow-key fallback, axis-separated collision slide, walk
// bob. Eye height rides terrainHeight via opts.groundHeight.
...
export function createPlayer(camera, domElement, opts) {
  const isWalkable = opts.isWalkable
  const groundHeight = opts.groundHeight
