...
// ---------- title narration ----------
// The 'begin' line ("El pantano calla como un ahogado...") belongs over the
...
// the first pointer/key/touch starts it — before BEGIN. BEGIN never restarts
// a line already out, and still speaks it the old way if nothing managed to
// start it earlier. Silent no-op without WebAudio or the clip file.
